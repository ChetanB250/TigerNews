...
function Header() {
    ...
    const isActiveClass = "block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500"
    const isInActiveClass = "block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
  ...
  return (
    <header>    
        <nav className="bg-white border-b-2 border-gray-200 dark:border-b-2 dark:border-slate-700 dark:bg-gray-900 p-2">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4">
        <Link to="/" className="flex items-center">
            <img src={Logo} className="h-12 w-12 mr-1 items-center" alt="TigerNews Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">TigerNews</span>
        </Link>
        <div className="flex lg:order-2">
            ...
            <div className={`items-center justify-between ${hidden ? "hidden" : ""} ${hidden ? "hidden" : ""} w-full md:flex md:w-auto md:order-1`} id="navbar-search">
            ...
            <ul className="flex flex-col p-4 lg:p-0 lg:text-center mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-900 md:dark:bg-gray-900 dark:border-gray-500">
                <li>
                <NavLink to="/" className={({isActive}) => isActive ? isActiveClass : isInActiveClass} end>Home</NavLink>
                </li>
                <li>
                <NavLink to="/business" className={({isActive}) => isActive ? isActiveClass : isInActiveClass}>Business</NavLink>
                </li>
                <li>
                <NavLink to="/entertainment" className={({isActive}) => isActive ? isActiveClass : isInActiveClass}>Entertainment</NavLink>
                </li>
                <li>
                <NavLink to="/health" className={({isActive}) => isActive ? isActiveClass : isInActiveClass}>Health</NavLink>
                </li>
                <li>
                <NavLink to="/science" className={({isActive}) => isActive ? isActiveClass : isInActiveClass}>Science</NavLink>
                </li>
                <li>
                <NavLink to="/sports" className={({isActive}) => isActive ? isActiveClass : isInActiveClass}>Sports</NavLink>
                </li>
                <li>
                <NavLink to="/technology" className={({isActive}) => isActive ? isActiveClass : isInActiveClass}>Technology</NavLink>
                </li>
            </ul>
            </div>
        </div>
